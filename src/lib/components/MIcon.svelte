<script lang="ts">
    ...
    const icons = {
        'add': `<svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 512.000000 512.000000" preserveAspectRatio="xMidYMid meet"><g transform="translate(0.000000,512.000000) scale(0.100000,-0.100000)" fill="currentColor" stroke="none"><path d="M2093 4466 c-155 -30 -265 -81 -390 -181 -98 -78 -171 -171 -228 -290 -78 -161 -80 -175 -80 -555 l0 -335 32 -116 c59 -215 146 -387 269 -533 103 -122 118 -153 119 -246 0 -64 -4 -82 -28 -123 -16 -26 -48 -62 -73 -80 -24 -18 -326 -169 -671 -337 -605 -294 -629 -307 -688 -365 -102 -101 -145 -210 -145 -365 1 -157 33 -230 123 -275 l51 -25 1856 0 1856 0 51 25 c87 44 122 118 123 261 0 161 -45 282 -144 379 -59 58 -82 70 -700 370 -435 211 -652 322 -681 347 -60 53 -89 124 -83 203 7 77 23 108 115 221 135 167 219 336 281 564 26 94 26 100 27 430 0 293 -2 343 -18 400 -26 94 -97 235 -158 313 -103 134 -288 255 -454 298 -103 26 -267 33 -362 15z"/> <path d="M4000 2965 l0 -295 -300 0 -300 0 0 -160 0 -160 300 0 300 0 2 -297 3 -298 85 1 c47 0 118 1 158 2 l72 2 0 295 0 295 295 0 296 0 -3 158 -3 157 -290 0 -290 0 -5 295 -5 295 -157 3 -158 3 0 -296z"/></g></svg>`,
        ...
        'locked': `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="24" viewBox="0 0 20 24"><path fill="currentColor" d="M3.5 6.5V10H2a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V12a2 2 0 0 0-2-2h-1.5V6.5a6.5 6.5 0 1 0-13 0M6 10V6.5a4 4 0 0 1 8 0V10zm2 5.5a2 2 0 1 1 3.092 1.676l-.008.005s.195 1.18.415 2.57v.001a.75.75 0 0 1-.749.749H9.248a.75.75 0 0 1-.749-.749v-.001l.415-2.57a2 2 0 0 1-.916-1.68z"/></svg>`,
        ...
        'home': `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M10 19v-5h4v5c0 .55.45 1 1 1h3c.55 0 1-.45 1-1v-7h1.7c.46 0 .68-.57.33-.87L12.67 3.6c-.38-.34-.96-.34-1.34 0l-8.36 7.53c-.34.3-.13.87.33.87H5v7c0 .55.45 1 1 1h3c.55 0 1-.45 1-1"/></svg>`,
