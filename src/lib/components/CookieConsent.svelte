...
{#if showBanner}
	<div class="cookie-banner" role="alert" aria-live="polite">
		<div class="cookie-content">
			<p>
				This website uses cookies to maintain your login session and improve your experience. 
				By continuing to use this site, you consent to our use of cookies for authentication purposes.
			</p>
